...
import GalleryModal from "./RouterFetch2-ModalRenderer.jsx";
  ...
  render() {
    return (
      <article
        ...
        style={{ columnCount: this.state.columns }}
      >
        ...
        {this.state.records.length > 0 ? (
          this.state.records.map((record, index) => (
            <Card key={index} id={record.fields["recordID"]}>
              <figure>
                <Link to={`/gallery/${record.fields["recordID"]}`} onClick={() => this.handleShow(record.fields["recordID"],
                    record.fields["Name"],
                ...
                <figcaption>
                  ...
                  <h4>{record.index}</h4>
                  <p>
                    <time dateTime={record.fields["YearText"]}>
                      {record.fields["YearText"]}
                    </time>
                  </p>
              ...
              <Link to={`/gallery/${record.fields["recordID"]}`} onClick={() => this.handleShow(record.fields["recordID"],
                    ...
                    record.fields["Attachments"],
                    record.fields["Tags"],
                    record.fields["Software"])} className="view-link" data-link="internal">view</Link>
              </div>
            </Card>
          ))
        ) : (
          ...
          <Route
            ...
            render={(props) => <GalleryModal {...props}  
